...
# is appended into rows of size n
# anything larger is stacked vertically
render_images(list_to_output[[2]], size = 300, group = "a", n = 4, stack_yn = TRUE)
render_images(list_to_output[[2]], size = 500, group = "b", n = 2, stack_yn = TRUE)
render_images(list_to_output[[2]], size = 700, group = "c", n = 1, stack_yn = TRUE)
```
...
# is appended into rows of size n
# anything larger is stacked vertically
render_images(list_to_output[[3]], size = 300, group = "a", n = 4, stack_yn = TRUE)
render_images(list_to_output[[3]], size = 500, group = "b", n = 2, stack_yn = TRUE)
render_images(list_to_output[[3]], size = 700, group = "c", n = 1, stack_yn = TRUE)
...
# is appended into rows of size n
# anything larger is stacked vertically
render_images(list_to_output[[4]], size = 300, group = "a", n = 4, stack_yn = TRUE)
render_images(list_to_output[[4]], size = 500, group = "b", n = 2, stack_yn = TRUE)
render_images(list_to_output[[4]], size = 700, group = "c", n = 1, stack_yn = TRUE)
...
# is appended into rows of size n
# anything larger is stacked vertically
render_images(list_to_output[[5]], size = 300, group = "a", n = 4, stack_yn = TRUE)
render_images(list_to_output[[5]], size = 500, group = "b", n = 2, stack_yn = TRUE)
render_images(list_to_output[[5]], size = 700, group = "c", n = 1, stack_yn = TRUE)
